...
import WithdrawalHistoryDetailsPopup from '../../../components/popups/WithdrawalHistoryDetailsPopup';
import WithdrawalHistoryFilterPopup from '../../../components/popups/WithdrawalHistoryFilterPopup';
...
const WithdrawalHistoryScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Header
        headerTitle={AppLocalizedStrings.withdrawalHistoryScreen.withdrawal}
      />
      ...
      <View style={styles.multiFilterView}>
        <View style={styles.filterButton}>
          <Text style={styles.filterTitle}>
            {AppLocalizedStrings.withdrawalHistoryScreen.filter}
          </Text>
      ...
      <View>
        <Text style={styles.dateTitle}>November 2022</Text>
      ...
      <WithdrawalHistoryDetailsPopup
        isVisible={isVisible}
        setIsVisible={setIsVisible}
        toggleModal={onDetailsHandler}
      />
      <WithdrawalHistoryFilterPopup
