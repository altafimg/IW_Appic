...
const BusinessManagerAgeScreen = ({navigation, route}) => {
  ...
  const {check, formData} = route.params;

  const onGoBackHandler = () => {
    if (check == 'govt') {
      navigation.replace('BuisGovAccountManagerScreen', {formData});
    } else {
      navigation.replace('BuisGovAccountManagerScreen', {formData});
    }
  };
    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <Text style={styles.title}>
          {AppLocalizedStrings.dontHaveIdScreen.age}
        </Text>
...
export default BusinessManagerAgeScreen;
