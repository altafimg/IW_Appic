...
const DetailsDeliveryComponent = props => {
  const navigation = useNavigation();
  const dispatch = useDispatch();
  const adsId = props?.adsId || '';
  const check = props?.check || '';
  const adsStatus = props?.status || '';

  const applicants_id = props?.applicants_id || {};
  const {profile_picture, user_role, first_name, last_name, profile_name, _id} =
    applicants_id;
  ...
  const onManageHandler = () => {
    navigation.navigate('ApplicantsAllMediaScreen', {
      applicant_id: _id,
    });
  };
  ...
  const ReviewSubmitHandler = () => {
    if (ratingMessage?.trim() !== '') {
      ...
      // jobCreatorCommentAndRating?._id
  ...
  return (
    <View style={styles.container}>
      <View style={styles.statusView}>
        <Text style={styles.statusViewText}>{adsStatus}</Text>
      </View>
      ...
      <View>
        ...
        {status[0] === 'in progress' ? (
          <>
            ...
            <View style={styles.addNoteCardView}>
              <Text style={styles.influencerSubTitle}>In progress</Text>
            </View>
          </>
        ) : (
          <>
            <Text style={styles.influencerTitle}>Add a note</Text>
            <View style={styles.addNoteCardView}>
              <TextInput
                multiline
        ...
        {status[0] === 'in progress' ? (
          <>
            <Text style={styles.influencerTitle}>Media & Files</Text>
            <View style={styles.influencerCardView}>
              <Text style={styles.influencerSubTitle}>In progress</Text>
            </View>
          </>
          ...
          totalMediaFilesLength < 1 ? (
            <>
              <Text style={styles.influencerTitle}>Media or Files</Text>
              <View style={styles.influencerCardView}>
        ...
        {status[0] === 'in progress' ? (
          <>
            <Text style={styles.influencerTitle}>
              Social media posts with analytics
            </Text>
            <View style={styles.influencerCardView}>
              <Text style={styles.influencerSubTitle}>
                <Text style={styles.influencerSubTitle}>In progress</Text>
              ...
              <View style={styles.influencerCardView}>
                ...
                <View
                  ...
                  <Text
                    ...
                    {userSocialMediaPostLink?.length + ' media files uploaded'}
                  </Text>
                </View>
          ...
          <>
            ...
            <View style={styles.influencerCardView}>
              <TouchableOpacity onPress={toggleModal}>
                <Text style={styles.supportTitle}>Social media rights</Text>
              </TouchableOpacity>
            </View>
          </>
        ) : (
      ...
      {status[0] === 'cancelByInfluencer' ||
      status[0] === 'cancelByCustomer' ? (
        <>
            ...
            {userMatched ? (
              <>
                ...
                <TouchableOpacity
                  ...
                  disabled={reviewLoader} // Optional: Disable the button while loading
                >
                  {/* {reviewLoader ? (
      ...
      <TouchableOpacity style={styles.neddHelpView}>
        <Text
          style={[styles.neddHelpViewText, {textDecorationLine: 'underline'}]}>
          Need help?
        </Text>
      </TouchableOpacity>
    </View>
...
export default DetailsDeliveryComponent;
