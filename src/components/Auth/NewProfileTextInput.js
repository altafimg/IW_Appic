...
const NewProfileTextInput = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {isError('dateOfBirth') && (
        <Text style={styles.errorText}>
          {AppLocalizedStrings.newProfileDetailsScreen.pleaseSelectDOB}
        </Text>
      )}
      ...
      <View style={styles.inputMainView}>
        <View style={styles.titleView}>
          <Text style={styles.textInputTitle}>
            {AppLocalizedStrings.newProfileDetailsScreen.createUsername}
          </Text>
        </View>
      ...
      {formData.userName.trim() === '' ? (
        ...
        <View style={styles.existError}>
          ...
          <Text style={[styles.usernameError, {color: Colors.Success500}]}>
            {AppLocalizedStrings.accountManagerScreen.available}
          </Text>
        </View>
      ) : (
        <View style={styles.existError}>
      ...
      <DetailsTextInput
        ...
        placeholder={' '}
        editable={true}
        // frountTitle={AppLocalizedStrings.newProfileDetailsScreen.characters}
        frountTitle={
...
export default NewProfileTextInput;
