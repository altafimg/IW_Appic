    ...
    <View style={styles.container}>
      <View style={styles.profileContainer}>
        ...
        <View style={styles.profileRightContainer}>
          ...
          <Text style={styles.baseTitle}>Youtuber</Text>
          <Text style={styles.baseTitle}>Speaks English</Text>
          <Text style={styles.baseTitle}>Based in United States</Text>
...
export default JobDetailsProfileView;
