...
const QuickDetailComponent = props => {
    ...
    <SafeAreaView style={styles.container}>
      {/* {title == 'broadCast' && (
        <View style={{flexDirection: 'row', alignItems: 'center', gap: 20}}>
          ...
          />
          <Text style={[styles.quickTitleStyle, {fontSize: scale(18)}]}>
            Details
          </Text>
        </View>
      )} */}
          ...
          <View style={{paddingHorizontal: 10, marginTop: 10}}>
            ...
            {/* <View style={styles.infoView}>
              <Text style={styles.infoText}>
                {capitalizeFirstLetter(jobData?.quick_ads_title)}
              </Text>
            </View> */}
            ...
            /> */}
            <Image
              source={{uri: jobData?.thumbnail_picture_ads}}
              style={styles.backgroundImage}
            />
              ...
              <View style={{flexDirection: 'row'}}>
                <View
                  ...
                  <Text
                    ...
                    Applicants must be {jobData?.set_age_for_applicants}+ years
                  </Text>
                </View>
              </View>
            </View>
            ...
            {expend && (
              <View>
                <View
                  ...
                  <Text style={styles.infoText}>
                    {capitalizeFirstLetter(jobData?.bio)}
                  </Text>
                </View>
                ...
                <View
                  ...
                  <Text style={styles.infoText}>{jobData?.website_link}</Text>
                </View>

                {jobData?.images?.map(i => {
                ...
                <View
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {jobData?.content_right}
                    </Text>
                  </View>
                  {jobData?.customUserRights ==
                ...
                <View
                  ...
                  <Text style={styles.infoText}>{jobData?.apply_limit}</Text>
                </View>
              </View>
            )}
          </View>
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    ...
                    {jobData?.minimum_number_follower_influencer_each}
                  </Text>
              ...
              <View
                ...
                <View style={[styles.inputStyle]}>
                  <View
                    ...
                    <Text style={[styles.infoText, {marginTop: hp(-1.5)}]}>
                      {UtcDateConvert(jobData?.utcTimeDate)}
                    </Text>
                    {/* <Image
                      source={date}
                      style={{
                ...
                <View
                  ...
                  <View style={[styles.directionRowStyle, {marginTop: hp(-2)}]}>
                    <Text style={styles.infoText}>
                      {`${UtcTimeConvert(jobData?.utcTimeDate)}`}
                    </Text>
                    {/* <Image
                      source={time}
                      style={{
                  ...
                  <Text style={styles.infoText}>
                    {`${UtcTimeZoneConvert(jobData?.timeZone)}`}
                  </Text>
                </View>
              </View>
            )}
            ...
            {vibeExpend && (
              <View
                ...
                <View
                  ...
                  <View style={styles.directionRowStyle}>
                    <Text style={styles.infoText}>{jobData?.mood}</Text>
                    {/* <SVG.smallArrow /> */}
                  </View>
                </View>
          ...
          <View>
            {targetExpend && (
              <View
                ...
                <View>
                  <View style={styles.directionRowStyle}>
                    <Text style={styles.infoText}>{jobData?.country}</Text>
                    {/* <SVG.smallArrow /> */}
                  </View>
                </View>
                {jobData?.state ? (
                  <View>
                    <View style={styles.directionRowStyle}>
                      <Text style={styles.infoText}>{jobData?.state}</Text>
                      {/* <SVG.smallArrow /> */}
                    </View>
                  </View>
                ) : (
                ...
                {jobData?.city ? (
                  <View>
                    <View style={styles.directionRowStyle}>
                      <Text style={styles.infoText}>{jobData?.city}</Text>
                      {/* <SVG.smallArrow /> */}
                    </View>
                  </View>
                ) : (
