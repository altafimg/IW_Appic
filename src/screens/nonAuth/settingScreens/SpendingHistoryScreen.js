...
const SpendingHistoryScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Header
        headerTitle={AppLocalizedStrings.spendingHistoryScreen.spendingHistory}
      />
      ...
      <View style={styles.multiFilterView}>
        <View style={styles.filterButton}>
          <Text style={styles.filterTitle}>
            {AppLocalizedStrings.spendingHistoryScreen.filter}
          </Text>
