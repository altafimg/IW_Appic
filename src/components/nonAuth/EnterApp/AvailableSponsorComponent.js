...
const AvailableSponsorComponent = props => {
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            <Text style={styles.buttonTextStyle}>
              {AppLocalizedStrings.availableSponsorComponent.filter}
            </Text>
          ...
          <TouchableOpacity
            ...
            />
            <Text style={styles.buttonTextStyle}>
              {AppLocalizedStrings.availableSponsorComponent.location}
            </Text>
            {locationArray.length > 0 && <Text style={styles.dotStyle}>•</Text>}
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.6} style={styles.buttonStyle}>
            <SVG.Map width={17} height={17} style={styles.filterIconStyle} />
            <Text style={styles.buttonTextStyle}>
              {AppLocalizedStrings.availableSponsorComponent.map}
            </Text>
            {mapArray.length > 0 && <Text style={styles.dotStyle}>•</Text>}
          </TouchableOpacity>
        </View>
...
export default AvailableSponsorComponent;
