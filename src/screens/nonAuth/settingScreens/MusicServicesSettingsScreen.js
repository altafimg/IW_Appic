...
import {Switch, Text, View, TouchableOpacity, TextInput} from 'react-native';
...
const MusicServicesSettingsScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      <View>
        ...
        <Header
          headerTitle={AppLocalizedStrings.musicServicesSettingsScreen.music}
          subTitle={AppLocalizedStrings.musicServicesSettingsScreen.allow}
        />
        <View style={styles.main}>
          <View style={styles.cardMainView}>
            <View style={styles.cardHeaderView}>
              <Text style={styles.cradTitle}>
                {AppLocalizedStrings.musicServicesSettingsScreen.musicFeatures}
              </Text>
              <Tooltip
                width={257}
                height={'100@s'}
                ...
                popover={
                  <Text style={styles.tooltipTitle}>
                    {AppLocalizedStrings.musicServicesSettingsScreen.only}
                  </Text>
                }>
                <SVG.IButton />
              </Tooltip>
...
export default MusicServicesSettingsScreen;
